...
- **Description:** "The AP CSA classroom is quiet after school. Satija stands near the front desk holding a clipboard. Before you leave, she hands you a laminated Truth Table sheet and tells you not to lose it. The classroom door behind her is locked."
...
- **Prerequisites:**
  - Player starts the game already possessing Truth Table
...
1. Start in Front Desk with Truth Table already in inventory
2. Move to Whiteboard Wall
3. Use Truth Table on Whiteboard
4. Move to Computer Station
5. Take Rubber Duck
6. Use Rubber Duck on Computer
7. Move to Back Table
8. Take Index Cards
9. Use Index Cards on Table
10. Take Algorithm Card
11. Move to Bookshelf
12. Use Algorithm Card on Bookshelf
13. Take Java Manual
14. Move to Printer Corner
15. Use Java Manual on Printer
16. Take Printed Spec
17. Move to Rubric Board
18. Use Printed Spec on Rubric
19. Take Final Approval Stamp
20. Move to Classroom Door
21. Use Final Approval Stamp on Door
22. Escape the classroom
...
|---|---|---|---|---|
| Truth Table | Tool | Starts in player inventory | None | Whiteboard |
